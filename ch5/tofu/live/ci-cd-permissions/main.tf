...
module "iam_roles" {
  ...
  github_repo      = "pockymummy/fundamental-of-devops"
  ...
  tofu_state_bucket         = "fundamentals-of-devops-tofu-state-ttangpornpis"
  tofu_state_dynamodb_table = "fundamentals-of-devops-tofu-state-ttangpornpis"
}
